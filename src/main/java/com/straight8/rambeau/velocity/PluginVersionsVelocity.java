...
@Plugin(id = "pluginversions", name = "PluginVersions", version = "1.0.8", description = "List installed plugins and versions alphabetically", authors = {"drives_a_ford", "GabrielHD150", "SlimeDog"})
