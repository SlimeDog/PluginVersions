...
@Plugin(id = "pluginversions", name = "PluginVersions", version = "1.0.7", description = "List installed plugins and versions alphabetically", authors = {"SlimeDog", "drives_a_ford", "GabrielHD150"})
